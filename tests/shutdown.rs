...
//!
//! **IT COSTS MORE HERE THAN IN A LOGIC SERVICE, because this process holds the
...
//! nothing and has to infer the outcome from a severed stream, and under D23 a
//! caller reaches this module over ONE long-lived HTTP/2 connection per pod — so
